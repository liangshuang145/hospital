<template>
  <div name="List" class="list-panel">
    ...
    <el-table ref="multipleTable" :data="userList"   highlight-current-row @current-change="handleTableChange" height="520">
      ...
      <el-table-column prop="datelasttime" label="出生年月" width="180"/>
      <el-table-column prop="drugover" label="入党日期" width="180"/>
      <el-table-column prop="text09" label="评测结果" width="180"/>
      <el-table-column prop="text08" label="分数" width="180"/>
    </el-table>
