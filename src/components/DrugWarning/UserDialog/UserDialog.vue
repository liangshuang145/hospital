<template>
  <el-dialog :value="value" name="UserDialog" :visible="isShow" :before-close="handleClose" :title="title" width="750px" center>
    <el-form ref="form" :model="form" :rules="rule" label-width="110px" label-position="right">
      <tr>
        <td><el-form-item label="人员编号" prop="accountid">
          <el-input v-model="form.accountid" size="medium" :maxlength="30" placeholder="请输入人员编号"/>
        </el-form-item></td>
      ...
      <tr>
        ...
        <td><el-form-item label="使用药品" prop="usedrug">
          <el-input v-model="form.usedrug" size="medium" :maxlength="30" placeholder="请输入药品"/>
        </el-form-item></td>
      </tr>
      <tr>
        <td><el-form-item label="药品近效期提醒" prop="drugover ">
          <el-date-picker
            v-model="form.drugover" type="date" placeholder="选择日期" format="yyyy 年 MM 月 dd 日" value-format="yyyy-MM-dd">
          </el-date-picker>
        </el-form-item></td>
