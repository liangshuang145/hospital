...
<template>
  <div name="buttons" class="buttons">
    <el-row :gutter="20">
      ...
      <el-button plain class="grid-content bg-purple" @click="ImportExcel">本日效能排行</el-button>
      <el-button plain class="grid-content bg-purple" @click="manylook1">本周效能排行</el-button>
      <el-button plain class="grid-content bg-purple" @click="ImportExcel">本月效能排行</el-button>
      <el-button plain class="grid-content bg-purple" @click="manylook1">年度效能排行</el-button>
