...
<template>
  <el-main name="Conference">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item to="/Index/Conference">{{ pageTitle }}</el-breadcrumb-item>
    </el-breadcrumb>
...
<script>
  import Manage from '@/components/Conference/Manage/Manage.vue'
  import Tree from '@/components/Conference/Tree/Tree.vue'
