...
<template>
  <el-main name="DemocraticParties">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item to="/Index/Intellectual">{{ pageTitle }}</el-breadcrumb-item>
    </el-breadcrumb>
...
<script>
  import Manage from '@/components/Intellectual/Manage/Manage.vue'
  import Tree from '@/components/Intellectual/Tree/Tree.vue'
